...
<div class="hero-banner">
	<div class="container">
		<div class="row">
			<div class="col-sm-5 col-md-3">
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-12">
						...
						?>
						<h1><span><?php echo get_field('blog_sub_title',$id); ?></span> <?php echo get_field('blog_title',$id); ?></h1>
					</div>
				</div>
				<div class="form-group email-bar blog-signup">
					...
					<button type="button" class="btn submit-email-btn"><span class="right-arrow-icon"></span></button>
				</div>
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenu1">
							<div class="row">
								<div class="col-md-10 col-md-offset-1">							
									...
									<ul>
										<li class="active"><a href="<?php get_permalink($id); ?>" title="Latest Posts">Latest Posts</a></li>
										<li class="active"><a href="<?php  ?>" title="Latest Posts">Latest Posts</a></li>
			...
			<?php 
			$feature_post_id = get_field('feature_post',$id);
